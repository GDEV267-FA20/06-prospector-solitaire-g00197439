...
public class Layout : MonoBehaviour
{
    ...
    // This holds all of the possible names for the layer set by layerID
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        for(int i = 0; i < slotsX.Count; i++)
        {
            ...
            {
                // If the <slot> has a type attribute, parse it
            ...
            // Various attributrs are parsed into numerical values
